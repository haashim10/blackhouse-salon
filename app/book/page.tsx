      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 p-4 border rounded-lg bg-gray-50">
          ...
          <p className="text-gray-600 mb-4">
            Looking to book for multiple people? Our group booking option allows
            you to schedule appointments for friends or family at the same time.
          </p>
          <Link
            href="/book/group"
