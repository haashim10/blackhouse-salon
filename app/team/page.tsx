  ...
  return (
    <main className="pt-24">
      <div className="max-w-7xl mx-auto px-6">
        {/* Updated title with fixed-width container for animation */}
        <h1 className="text-4xl uppercase mb-6">
          {/* Container with fixed width based on text length - adjust the width as needed */}
          <div className="inline-block" style={{ width: "290px" }}>
            <span className="typing-animation typing-1">Meet The Team.</span>
          </div>
        </h1>
        <p className="text-muted max-w-3xl mb-16">
          Our talented stylists bring together diverse backgrounds and
          specialized skills to provide exceptional service tailored to your
          unique style.
        </p>
        ...
        {/* Featured Stylist */}
        <div
          className={`grid grid-cols-1 lg:grid-cols-2 gap-12 transition-opacity duration-300 ${
