...
const positions = [
  {
    ...
    type: "Full-time",
    description:
      "We're seeking an experienced hair stylist with a strong portfolio and passion for creating trending styles.",
  },
  {
    title: "Color Specialist",
    type: "Full-time",
    description:
      "Join our team as a color specialist with expertise in modern coloring techniques and trends.",
  },
  {
    title: "Junior Stylist",
    type: "Full-time",
    description:
      "Great opportunity for a newly qualified stylist to grow and develop their skills with our expert team.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h1 className="text-4xl uppercase mb-16">
          ...
          <div className="inline-block" style={{ width: "180px" }}>
            <span className="typing-4">Careers.</span>
          </div>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <div className="space-y-6">
            ...
            <p className="text-muted">
              At BLACKHOUSE SALON, we&apos;re always looking for talented
              individuals who share our passion for creativity and excellence in
              hair styling.
            </p>
