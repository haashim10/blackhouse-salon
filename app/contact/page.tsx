  ...
  return (
    <main className="pt-24">
      <div className="max-w-7xl mx-auto px-6">
        <h1 className="text-4xl uppercase mb-16">Contact Us</h1>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a href="https://instagram.com" className="text-muted hover:text-accent">Instagram</a>
                <a href="https://facebook.com" className="text-muted hover:text-accent">Facebook</a>
              </div>
            </div>
          </div>
